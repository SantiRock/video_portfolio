export const videosApi = {
  ...
  pink_paradize: {
    ...
    equipo: [
        ...
        },      
        {
            id: 'manu',
            cargo: 'DJ',
            nombre: 'The Driver Aka Manu le Malin'
        },
        {
            id: 'mas',
            cargo: 'Agradecimientos',
  ...
  der_kirchgarten : {
    ...
    equipo: [
        ...
        },
        {
            id: 'iote',
            cargo: 'Dramaturgia',
            nombre: 'Charlotte von Bausznern'
        },
        {
            id: 'jan',
            cargo: 'Escenógrafo',
    ...
    enlaces: [
        {
            id: 'vimeo',
            enlace: 'https://vimeo.com/310680608',
            text: 'Video de Video-Mapping'
        },
        {
            id: 'parisa',
  ...
  die_originale : {
    ...
    equipo: [
        ...
        },
        {
            ...
            nombre: 'Charlotte Le May'
        },
        {
            id: 'emile',
            cargo: 'Artista de Circo',
            nombre: 'Emile Pineault'
        },
        {
            id: 'io',
            cargo: 'Artista de Video',
    ...
    enlaces: [
        ...
        {
            id: 'youtube',
            enlace: 'https://www.youtube.com/watch?v=CCOgXw65ifA',
            text: 'Trailer'
        },
        {
            id: 'fotos',
  ...
  lpm2018 : {
    ...
    enlaces: [
        ...
        {
            id: 'video',
            enlace: 'https://vimeo.com/897758225',
            text: 'Video'
        },
    ],
